...
object NetworkService {
    ...
    object BaseUrl {
        ...
        object Kaluga {
            const val MOSREG_SECONDARY = "https://education.admoblkaluga.ru/"
            const val MOSREG_SCHOOL_API = "https://api.admoblkaluga.ru/"
            const val MOSREG_DNEVNIK = "https://dnevnik.admoblkaluga.ru/"
    ...
    fun mosAuthApi() = baseApiConstructor<MosAuthAPI>(BaseUrl.MOS.MOS_AUTH)
    fun regionalAuthApi() = baseApiConstructor<RegionalAuthAPI>(BaseUrl.Kaluga.MOSREG_SECONDARY) //TODO change
